...
\begin{sidewaysfigure}[htbp]
    \centering
    \includegraphics[scale=0.25,angle=0]{MWP-Project Report Template - BD-ML-June25/methodology_images/KafkaML_Federated_Full.png}
...
\begin{sidewaysfigure}[htbp]
    \centering
    \includegraphics[scale=0.30,angle=0]{MWP-Project Report Template - BD-ML-June25/methodology_images/KafkaML_Phase1_Init.png}
...
\begin{sidewaysfigure}[htbp]
    \centering
    \includegraphics[scale=0.30,angle=0]{MWP-Project Report Template - BD-ML-June25/methodology_images/KafkaML_Phase2_Loop.png}
