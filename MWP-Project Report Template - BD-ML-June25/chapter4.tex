...
Federated deployments reuse the classic Kafka-ML services (frontend, backend API, model training, model inference) and add asynchronous coordination so that models and client datasets remain decoupled until a federated round is ready. the key stages are summarised below.
...
The deployment process and operational status for the blockchain-instrumented federated training are illustrated in Figs.~\ref{fig:blockchain_fed_placeholders} and \ref{fig:blockchain_fed_placeholders2}.
...
\begin{figure}[h!]
    ...
    \begin{adjustbox}{bgcolor=gray!20, padding=0.7em, margin=1ex}
        \begin{tabular}{cc}
            \begin{subfigure}{0.48\textwidth}
                \centering
                \includegraphics[width=\linewidth]{screenshots_federated_blokchain/1_pods_running.png}
                \caption{Initial Running Pods}
            \end{subfigure} &
            \begin{subfigure}{0.48\textwidth}
                \centering
                \includegraphics[width=\linewidth]{screenshots_federated_blokchain/2_pods_running_after_deployment.png}
                \caption{Pods After Deployment}
            \end{subfigure} \\
            \begin{subfigure}{0.48\textwidth}
                \centering
                \includegraphics[width=\linewidth]{screenshots_federated_blokchain/3_pods_running_after_fed_training_worker.png}
                \caption{Worker Training Pods}
            \end{subfigure} &
            \begin{subfigure}{0.48\textwidth}
                \centering
                \includegraphics[width=\linewidth]{screenshots_federated_blokchain/4_data_injection.png}
                \caption{Data Injection}
            \end{subfigure}
        \end{tabular}
    \end{adjustbox}
    \vskip\baselineskip
    \caption{Blockchain-instrumented federated training deployment and initialization}
...
\begin{figure}[h!]
    ...
    \begin{adjustbox}{bgcolor=gray!20, padding=0.7em, margin=1ex}
        \begin{tabular}{cc}
            \begin{subfigure}{0.48\textwidth}
                \centering
                \includegraphics[width=\linewidth]{screenshots_federated_blokchain/5_worker_training_logs.png}
                \caption{Worker Training Logs}
            \end{subfigure} &
            \begin{subfigure}{0.48\textwidth}
                \centering
                \includegraphics[width=\linewidth]{screenshots_federated_blokchain/6_cotroller_training_logs.png}
                \caption{Controller Training Logs}
            \end{subfigure}
        \end{tabular}
    \end{adjustbox}
    \vskip\baselineskip
    \caption{Blockchain-instrumented federated training execution and blockchain logging}
    \label{fig:blockchain_fed_placeholders2}
\end{figure}
