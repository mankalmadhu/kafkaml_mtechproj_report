...
The deployment process and operational status of the federated module with blockchain instrumentation are illustrated in Fig.~\ref{fig:blockchain_fed_placeholders}.
...
\begin{figure}[h!]
    ...
    \end{adjustbox}
    \vskip\baselineskip
    \caption{Federated Kafka ML Build and Deploy Steps (Blockchain-enabled)}
