...
\begin{figure}[h!]
    ...
    \begin{adjustbox}{bgcolor=gray!20, padding=0.7em, margin=1ex}
        \begin{tabular}{cc}
            ...
            \begin{subfigure}{0.48\textwidth}
                \centering
                \fbox{\parbox{\linewidth}{\centering\vspace{3cm}[Placeholder: Build Script]}}
                \caption{Build Script}
            \end{subfigure} &
            \begin{subfigure}{0.48\textwidth}
                \centering
                \fbox{\parbox{\linewidth}{\centering\vspace{3cm}[Placeholder: Docker Images]}}
                \caption{Docker Images}
            \end{subfigure} \\
            % Second row
            \begin{subfigure}{0.48\textwidth}
                \centering
                \fbox{\parbox{\linewidth}{\centering\vspace{3cm}[Placeholder: Deployment Script]}}
                \caption{Deployment Script}
            \end{subfigure} &
            \begin{subfigure}{0.48\textwidth}
                \centering
                \fbox{\parbox{\linewidth}{\centering\vspace{3cm}[Placeholder: Running Kubernetes Pods]}}
                \caption{Running Kubernetes Pods}
            \end{subfigure}
        \end{tabular}
    \end{adjustbox}
...
\begin{enumerate}
    ...
    \begin{figure}[h!]
        \centering
        \fbox{\parbox{0.7\textwidth}{\centering\vspace{4cm}[Placeholder: Model Control Input]}}
    ...
    \begin{figure}[h!]
        \centering
        \fbox{\parbox{0.7\textwidth}{\centering\vspace{4cm}[Placeholder: Data Control Input]}}
...
\begin{figure}[h!]
    \centering
    \fbox{\parbox{0.8\textwidth}{\centering\vspace{4cm}[Placeholder: Federated Training Job Running]}}
