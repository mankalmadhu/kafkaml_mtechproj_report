...
\begin{figure}[h!]
    ...
    \begin{adjustbox}{bgcolor=gray!20, padding=0.7em, margin=1ex}
        \begin{tabular}{cc}
            \begin{subfigure}{0.48\textwidth}
                \centering
                \fbox{\parbox{0.9\linewidth}{Placeholder: Federated controller pod status}}
                \caption{Controller Pods}
            \end{subfigure} &
            \begin{subfigure}{0.48\textwidth}
                \centering
                \fbox{\parbox{0.9\linewidth}{Placeholder: Backend UI with control entries}}
                \caption{Control Entries}
            \end{subfigure} \\
            \begin{subfigure}{0.48\textwidth}
                \centering
                \fbox{\parbox{0.9\linewidth}{Placeholder: Data injector publishing occupancy events}}
                \caption{Data Injection}
            \end{subfigure} &
            \begin{subfigure}{0.48\textwidth}
                \centering
                \fbox{\parbox{0.9\linewidth}{Placeholder: Worker training metrics view}}
                \caption{Worker Metrics}
            \end{subfigure}
        \end{tabular}
    \end{adjustbox}
    \vskip\baselineskip
    \caption{Reserved placeholders for occupancy-focused federated walkthrough}
    \label{fig:occupancy_placeholders}
\end{figure}
